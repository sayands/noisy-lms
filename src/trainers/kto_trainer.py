...
if __name__ == "__main__":
    parser = TrlParser((KTOConfig, TokenizerConfig, ModelConfig, DatasetConfig))
    ...
    model_ref.config.end_token_id = tokenizer.eos_token_id
    model_ref.config.pad_token_id = model.config.eos_token_id
    
    dataset_config.max_token_length = train_config.max_length
    dataset_config.preprocess_kto_tokenizer = tokenizer
